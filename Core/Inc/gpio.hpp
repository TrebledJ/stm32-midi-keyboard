...
#ifdef GPIOA_BASE
struct PA {
    static constexpr uintptr_t base = GPIOA_BASE;
};
#endif
#ifdef GPIOB_BASE
struct PB {
    static constexpr uintptr_t base = GPIOB_BASE;
};
#endif
#ifdef GPIOC_BASE
struct PC {
    static constexpr uintptr_t base = GPIOC_BASE;
};
#endif
#ifdef GPIOD_BASE
struct PD {
    static constexpr uintptr_t base = GPIOD_BASE;
};
#endif
#ifdef GPIOE_BASE
struct PE {
    static constexpr uintptr_t base = GPIOE_BASE;
};
#endif
#ifdef GPIOF_BASE
struct PF {
    static constexpr uintptr_t base = GPIOF_BASE;
};
#endif
...
struct gpio {
    ...
    {
        HAL_GPIO_WritePin((GPIO_TypeDef*)PORT::base, (1 << PIN), value ? GPIO_PIN_SET : GPIO_PIN_RESET);
    }
