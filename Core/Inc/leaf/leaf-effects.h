...
/*!
 ...
 @fn void     tTalkbox_lpc            (float *buf, float *car, double* dl, double* Rt, int32_t n, int32_t o, float warp,
 int warpOn, float *k, int freeze, float *G)
 @brief
 @param talkbox A pointer to the relevant tTalkbox.
 ...
 @fn void     tTalkbox_warpedAutocorrelate    (float * x, double* dl, double* Rt, unsigned int L, float * R, unsigned
 int P, float lambda)
 @brief
 @param talkbox A pointer to the relevant tTalkbox.
...
/*!
 ...
 @fn void     tTalkboxFloat_lpc            (float *buf, float *car, float* dl, float* Rt, int32_t n, int32_t o, float
 warp, int warpOn, float *k, int freeze, float *G)
 @brief
 @param talkbox A pointer to the relevant tTalkboxFloat.
 ...
 @fn void     tTalkboxFloat_warpedAutocorrelate    (float * x, float* dl, float* Rt, unsigned int L, float * R, unsigned
 int P, float lambda)
 @brief
 @param talkbox A pointer to the relevant tTalkboxFloat.
...
/*!
 ...
 @fn void   tRosenbergGlottalPulse_setOpenLengthAndPulseLength           (tRosenbergGlottalPulse* const gp, float
...
void tRosenbergGlottalPulse_setOpenLengthAndPulseLength(tRosenbergGlottalPulse* const, float openLength,
                                                        float pulseLength);
...
/*!
 ...
 @ingroup effects
 @brief pitch shifting algorithm that underlies tRetune etc from Katja Vetters
 http://www.katjaas.nl/pitchshiftlowlatency/pitchshiftlowlatency.html
 @{
...
/*!
 ...
 @fn void    tPitchShift_init            (tPitchShift* const, tPeriodDetection* const, float* out, int bufSize, LEAF*
 const leaf)
 ...
 @fn void    tPitchShift_initToPool      (tPitchShift* const, tPeriodDetection* const, float* out, int bufSize,
 tMempool* const)
...
/*!
 ...
 @fn void    tSimpleRetune_init                  (tSimpleRetune* const, int numVoices, int bufSize, int frameSize, LEAF*
 const leaf)
 ...
 @fn void    tSimpleRetune_initToPool            (tSimpleRetune* const, int numVoices, int bufSize, int frameSize,
 tMempool* const)
...
void tSimpleRetune_init(tSimpleRetune* const, int numVoices, float minInputFreq, float maxInputFreq, int bufSize,
                        LEAF* const leaf);
void tSimpleRetune_initToPool(tSimpleRetune* const, int numVoices, float minInputFreq, float maxInputFreq, int bufSize,
                              tMempool* const);
...
void tRetune_initToPool(tRetune* const, int numVoices, float minInputFreq, float maxInputFreq, int bufSize,
                        tMempool* const);
