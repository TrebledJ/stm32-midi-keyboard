...
/*!
 ...
 @fn void    tEnvelopeFollower_init          (tEnvelopeFollower* const follower, float attackThreshold, float
 decayCoeff, LEAF* const leaf)
 ...
 @fn void    tEnvelopeFollower_initToPool    (tEnvelopeFollower* const follower, float attackThreshold, float
 decayCoeff, tMempool* const mempool)
...
void tEnvelopeFollower_init(tEnvelopeFollower* const follower, float attackThreshold, float decayCoefficient,
                            LEAF* const leaf);
void tEnvelopeFollower_initToPool(tEnvelopeFollower* const follower, float attackThreshold, float decayCoefficient,
...
/*!
 ...
 @fn void    tZeroCrossingCounter_init         (tZeroCrossingCounter* const counter, int maxWindowSize, LEAF* const
 leaf)
 ...
 @fn void    tZeroCrossingCounter_initToPool   (tZeroCrossingCounter* const counter, int maxWindowSize, tMempool* const
 mempool)
...
/*!
 ...
 @param factor Smoothing factor of the moving average. 0.0-1.0, with a higher value discounting older inputs more
 quickly.
 @param leaf A pointer to the leaf instance.
...
/*!
 ...
 @fn void    tAttackDetection_init           (tAttackDetection* const, int blocksize, int atk, int rel, LEAF* const
 leaf)
...
/*!
 ...
 @fn void    tPeriodDetection_init               (tPeriodDetection* const, float* in, float* out, int bufSize, int
 frameSize, LEAF* const leaf)
 ...
 @fn void    tPeriodDetection_initToPool  (tPeriodDetection* const, float* in, float* out, int bufSize, int frameSize,
 tMempool* const)
...
void tZeroCrossingCollector_initToPool(tZeroCrossingCollector* const, int windowSize, float hysteresis,
                                       tMempool* const);
...
/*!
 ...
 @fn void    tPeriodDetector_init    (tPeriodDetector* const detector, float lowestFreq, float highestFreq, float
 hysteresis, LEAF* const leaf)
 @brief Initialize a tPeriodDetector to the default mempool of a LEAF instance.
 @param
 @param leaf A pointer to the leaf instance.

 @fn void    tPeriodDetector_initToPool  (tPeriodDetector* const detector, float lowestFreq, float highestFreq, float
 hysteresis, tMempool* const mempool)
...
void tPeriodDetector_init(tPeriodDetector* const detector, float lowestFreq, float highestFreq, float hysteresis,
                          LEAF* const leaf);
void tPeriodDetector_initToPool(tPeriodDetector* const detector, float lowestFreq, float highestFreq, float hysteresis,
                                tMempool* const mempool);
...
/*!
 ...
 @fn void    tPitchDetector_initToPool   (tPitchDetector* const detector, float lowestFreq, float highestFreq, tMempool*
 const mempool)
...
void tPitchDetector_initToPool(tPitchDetector* const detector, float lowestFreq, float highestFreq,
                               tMempool* const mempool);
...
/*!
 ...
 @fn void tDualPitchDetector_init (tDualPitchDetector* const detector, float lowestFreq, float highestFreq, float*
 inBuffer, int bufSize, LEAF* const leaf)
 ...
 @fn void tDualPitchDetector_initToPool (tDualPitchDetector* const detector, float lowestFreq, float highestFreq, float*
 inBuffer, int bufSize, tMempool* const mempool)
...
void tDualPitchDetector_init(tDualPitchDetector* const detector, float lowestFreq, float highestFreq, float* inBuffer,
                             int bufSize, LEAF* const leaf);
void tDualPitchDetector_initToPool(tDualPitchDetector* const detector, float lowestFreq, float highestFreq,
                                   float* inBuffer, int bufSize, tMempool* const mempool);
