...
/*! @}
 ...
 @param poly A pointer to the relevant tPoly.
 @param numVoices The new number of available voices. Cannot be greater than the max number voices given in
 tPoly_init().
...
/*! @}
 ...
 @brief Find if there is a voice with that note -- useful for note offs where you want to wait to remove it from the
 poly until the release phase of the envelope is finished
 @param

 @fn void    tSimplePoly_setNumVoices          (tSimplePoly* const poly, uint8_t numVoices)
 @brief Set the number of voices available to play notes.
 @param poly A pointer to the relevant tSimplePoly.
 @param numVoices The new number of available voices. Cannot be greater than the max number voices given on
 initialization.
