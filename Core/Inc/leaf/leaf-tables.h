...
// mtof lookup table based on input range [0.0,1.0) in 4096 increments - midi frequency values scaled between m25 and
// m134 (from the Snyderphonics DrumBox code)
