...
/*!
 ...
 @brief
 @param delay A pointer to the relevant tDelay.
 @param delayLength The new delay length in samples. Cannot be greater than the max delay length given on
 initialization.
...
/*!
 ...
 @fn void       tHermiteDelay_init             (tHermiteDelay* const dl, float delay, uint32_t maxDelay, LEAF* const
 leaf)
