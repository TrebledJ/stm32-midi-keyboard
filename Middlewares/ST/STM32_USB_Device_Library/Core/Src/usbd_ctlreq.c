...
USBD_StatusTypeDef USBD_StdDevReq(USBD_HandleTypeDef* pdev, USBD_SetupReqTypedef* req)
{
    ...
    switch (req->bmRequest & USB_REQ_TYPE_MASK) {
        ...
        case USB_REQ_TYPE_VENDOR: ret = (USBD_StatusTypeDef)pdev->pClass->Setup(pdev, req); break;
        ...
        case USB_REQ_TYPE_STANDARD:
            switch (req->bRequest) {
                ...
                case USB_REQ_SET_CONFIGURATION: ret = USBD_SetConfig(pdev, req); break;
...
static void USBD_GetDescriptor(USBD_HandleTypeDef* pdev, USBD_SetupReqTypedef* req)
{
    ...
    switch (req->wValue >> 8) {
        ...
        case USB_DESC_TYPE_BOS:
            ...
            break;
#endif
        case USB_DESC_TYPE_DEVICE: pbuf = pdev->pDesc->GetDeviceDescriptor(pdev->dev_speed, &len); break;
...
static void USBD_GetConfig(USBD_HandleTypeDef* pdev, USBD_SetupReqTypedef* req)
{
    if (req->wLength != 1U) {
        ...
        switch (pdev->dev_state) {
            ...
            case USBD_STATE_CONFIGURED: (void)USBD_CtlSendData(pdev, (uint8_t*)&pdev->dev_config, 1U); break;
